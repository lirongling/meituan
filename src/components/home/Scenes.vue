    ...
    <div class="container">
      <div class="container-nav">
        <ul class="flex content">
          ...
          <li class="nav-item" @mouseenter="searchResultss('景点',0)"><span>全部</span><span class="navs-item" :class="{'show-navs':num===0 }"></span></li>
          <li class="nav-item" @mouseenter="searchResultss('美食',1)"><span>约会聚餐</span><span class="navs-item" :class="{'show-navs':num===1 }"></span></li>
          <li class="nav-item" @mouseenter="searchResultss('丽人',2)"><span>丽人spa</span><span class="navs-item" :class="{'show-navs':num===2 }"></span></li>
          <li class="nav-item" @mouseenter="searchResultss('电影',3)"><span>电影演出</span><span class="navs-item" :class="{'show-navs':num===3 }"></span></li>
          <li class="nav-item" @mouseenter="searchResultss('旅游',4)"><span>品质出游</span><span class="navs-item" :class="{'show-navs':num===4 }"></span></li>
        </ul>
      </div>
        ...
        <div class="quality-item" v-for="(item,index) in searchResult" :key="index">
          <Card style="width:100%" :bordered="false">
            ...
            <div class="quality-img" v-else>
              <img src="https://img.meituan.net/phoenix/37ac7809abcd942e05aeb0e3add1fcba294604.jpg@740w_416h_1e_1c"/>
            </div>
            <div class="poi-info">
              ...
              <div class="price-info flex">
                <div>
                  ...
                  <span v-if="item.tel.length>0">
                    <span class="old-price"><span class="phone">电话:</span>{{getPhone(item.tel)}}</span>
                  </span>
                  <span v-else>
    ...
    export default {
        ...
        methods: {
            ...
            searchResults(val,index) {
                ...
                this.$axios
                    .req(
                        `results?city=${this.$store.state.city}&keyword=${val}`
                    )
                    .then(res => {
                        if (res.code === 200) {
